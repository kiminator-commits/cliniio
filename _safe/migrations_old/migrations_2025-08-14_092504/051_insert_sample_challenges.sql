-- Migration: Insert sample challenges for Today's Challenge functionality
-- This migration adds sample challenges to populate the home_challenges table

-- Insert sample challenges using existing test user and facility
