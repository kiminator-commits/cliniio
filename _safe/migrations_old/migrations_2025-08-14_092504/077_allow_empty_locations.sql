-- Migration: Allow empty locations in inventory items
-- This modifies the validate_inventory_item function to allow empty location values

-- Drop the existing trigger first
DROP TRIGGER IF EXISTS validate_inventory_item_trigger ON inventory_items;

-- Update the validation function to allow empty locations
...
BEGIN
  ...
  IF NEW.current_quantity > NEW.maximum_quantity THEN
