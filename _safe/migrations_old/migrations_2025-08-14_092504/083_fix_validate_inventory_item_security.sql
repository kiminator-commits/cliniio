-- Migration: Fix validate_inventory_item function security
-- This fixes the "Function Search Path Mutable" security issue by setting an explicit search path
...
DROP FUNCTION IF EXISTS validate_inventory_item();

-- Recreate the function with explicit search path for security
