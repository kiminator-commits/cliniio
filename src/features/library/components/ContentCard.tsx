  ...
  return (
    ...
    >
      ...
      {onToggleFavorite && (
        ...
        >
          <Icon path={mdiStar} size={1.2} color={isFavorite ? '#FFD700' : '#9CA3AF'} />
        </button>
      )}
        ...
        <div className="flex-1">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              {item.source === 'Cliniio' && (
                <div className="flex items-center gap-1 px-2 py-1 bg-blue-50 text-blue-500 rounded-full text-xs font-medium border border-blue-200">
