...
export class InventoryItemCrudProvider {
  ...
  async updateItem(
    ...
    const result = await InventoryErrorHandler.handleOperation(
      'updateItem',
      async () => {
        const result = await this.adapter.updateInventoryItem(id, updates as any);
  ...
  async addInventoryItem(item: LocalInventoryItem): Promise<InventoryItem> {
    const result = await InventoryErrorHandler.handleOperation(
      'addInventoryItem',
      async () => {
        const result = await this.adapter.addInventoryItem(item as any);
  ...
  async duplicateItem(
    ...
    const result = await InventoryErrorHandler.handleOperation(
      ...
      async () => {
        ...
        const result = await this.adapter.addInventoryItem(duplicatedItem as any);
        cacheInvalidationService.invalidateRelated(
          'inventory:create',
          result.id
        );
