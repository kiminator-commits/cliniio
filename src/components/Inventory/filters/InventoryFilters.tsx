...
const InventoryFilters: React.FC<InventoryFiltersProps> = React.memo(
  ({ filters, showFilters, setShowFilters, onToggleTrackedFilter }) => {
    ...
    return (
      <>
        <div
          className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-2 overflow-x-hidden"
          role="toolbar"
          ...
          <div className="flex items-center gap-2">
            ...
            {onToggleTrackedFilter && (
              <Button
                ...
                variant="outline-secondary"
                className={`font-medium px-4 py-2 rounded-md border border-gray-300 shadow-sm flex items-center focus:outline-none focus:ring-2 focus:ring-[#4ECDC4] focus:ring-offset-1 min-w-fit whitespace-nowrap ${
