              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-4 py-3 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <span
                      className={`inline-flex items-center justify-center w-6 h-6 ${ICONS.SECTION_NUMBER} text-xs font-medium rounded-full`}
                    >
                      {section.order}
                    </span>
                    <div>
              ...
              <div className="p-3 space-y-2">
                {section.items.length === 0 ? (
                  <div className="text-center py-4 text-gray-400">
                    ...
                    <p className="text-xs">{UI_TEXT.ADD_CONTENT_INSTRUCTION}</p>
                  </div>
                ) : (
                  selectedPathwayItems
                    .filter((item) => section.items.includes(item.pathwayId))
                    .map((item, itemIndex) => (
                      <div
                        key={item.pathwayId}
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-2 mb-1">
                              <span
                                className={`inline-flex items-center justify-center w-5 h-5 ${ICONS.ITEM_NUMBER} text-xs font-medium rounded-full`}
                              >
                                {itemIndex + 1}
                              </span>
                              <span
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center space-x-1 ml-3">
                  ...
                  <button
                    onClick={() => movePathwayItem(item.pathwayId, 'down')}
