...
> = ({ summary, hasHighRiskItems, getUrgentActions, setActiveTab }) => {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {(summary.toolReplacement?.length || 0) +
                  (summary.autoclaveCapacity?.length || 0) +
                  (summary.supplyDepletion?.length || 0)}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900 capitalize">
                {summary.auditRisk?.riskLevel || 'No data'}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                $
                {(
                  summary.efficiencyROI?.estimatedLaborSavings || 0
                ).toLocaleString()}
              </p>
            </div>
          </div>
      ...
      {summary.supplyDepletion && summary.supplyDepletion.length > 0 ? (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            {summary.supplyDepletion
              .slice(0, 3)
              .map((item: SupplyDepletion, index: number) => (
                <div
                  key={index}
      ...
      {summary.toolTurnoverUtilization &&
      summary.toolTurnoverUtilization.length > 0 ? (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            {summary.toolTurnoverUtilization
              .slice(0, 3)
              .map((tool: ToolTurnoverUtilization, index: number) => (
                <div
                  key={index}
